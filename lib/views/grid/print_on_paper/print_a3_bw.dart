...
class PrintA3Bw extends StatefulWidget {
  const PrintA3Bw({super.key});

  @override
  State<PrintA3Bw> createState() => _PrintA3BwState();
}

class _PrintA3BwState extends State<PrintA3Bw> {
  @override
      ...
      body: SingleChildScrollView(
        child: Column(
          ...
          children: [
            ...
            Card(
              child: Image.asset(
                "assets/images/printonpaper/printa3bw.png",
              ),
            ),
            SizedBox(
              height: 24,
